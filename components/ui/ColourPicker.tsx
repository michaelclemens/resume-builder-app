    ...
    <>
      ...
      {showPicker && (
        <div
          title="Colour Picker"
          ref={pickerRef}
          className={`absolute z-50 flex translate-x-9 -translate-y-10 flex-col items-center rounded-lg bg-black/50 p-3 shadow-md ring-1 ring-slate-300/60 backdrop-blur-sm dark:ring-slate-400/20`}
        >
