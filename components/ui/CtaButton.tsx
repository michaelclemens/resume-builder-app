  ...
  return (
    <div className="mx-1 my-3 rounded-lg p-3 shadow-md ring-1 ring-slate-300/60 backdrop-blur-sm dark:text-black dark:ring-slate-400/20">
      <button
        ...
        disabled={disabled}
        onClick={onClick}
        className="relative w-full rounded-md bg-slate-300/70 px-2 py-5 text-4xl font-bold ring-1 ring-slate-700/30 transition-all duration-500 hover:bg-slate-300 disabled:select-none disabled:opacity-50 dark:bg-slate-900/70 dark:ring-slate-400/20 hover:dark:bg-slate-900"
      >
