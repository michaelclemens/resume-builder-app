...
export default function SectionForm({
  ...
  return (
    <div className="relative mx-1 mt-3 mb-1 min-h-24 rounded-lg p-3 shadow-md ring-1 ring-slate-300/60 backdrop-blur-sm dark:text-black dark:ring-slate-400/20">
