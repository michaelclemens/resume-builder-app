...
export async function addPersonal(resumeId: string, formData: PersonalSchemaType) {
    try {
...
export async function updatePersonal(id: string, resumeId: string, formData: PersonalSchemaType) {
    try {
