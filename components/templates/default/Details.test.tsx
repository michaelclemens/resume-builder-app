...
describe('DefaultDetailsComponent', () => {
  ...
  it('Should render the correct details', () => {
    ...
    expect(queryByText(regexString('address'))).not.toBeInTheDocument()
    expect(queryByText(regexString('phone'))).not.toBeInTheDocument()
    expect(queryByText(regexString('email'))).not.toBeInTheDocument()
    ...
    expect(getByText(regexString('address'))).toBeInTheDocument()
    expect(getByText(regexString('phone'))).toBeInTheDocument()
    expect(getByText(regexString('email'))).toBeInTheDocument()
