...
export default function ListButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`rounded-md px-2 ${paddingY} font-medium text-white shadow-sm ring-1 ring-slate-300/60 transition-colors duration-500 hover:bg-slate-200/70 dark:ring-slate-400/20 dark:hover:bg-slate-600/70 ${className}`}
    >
      {button}
    </button>
  )
