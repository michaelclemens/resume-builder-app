...
export default function ListButton({
  ...
  return (
    <button
      disabled={disabled}
      onClick={onClick}
      className={`${className} ${Icon && iconClassNameMap[type]} ${paddingY} flex justify-center rounded-md px-2 font-medium text-white shadow-sm ring-1 ring-slate-300/60 transition-colors duration-500 hover:bg-slate-200/70 disabled:opacity-50 disabled:select-none dark:ring-slate-400/20 dark:hover:bg-slate-600/70`}
    >
