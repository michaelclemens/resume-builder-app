...
export const renderFormBody = (
    { component: FormBodyComponent, editing, defaultValues, schema, onSave }:
    { component: any, editing: boolean, defaultValues: any, schema: any, onSave: any }
) => {
