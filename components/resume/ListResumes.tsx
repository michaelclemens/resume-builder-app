...
export default function ListResumes({ resumes }: { resumes: Resume[] | null }) {
  ...
  return (
    <div className="mx-auto flex w-1/2 justify-center">
      <div className="relative flex min-w-52 max-w-full rounded-lg px-5 py-2 text-white shadow-md ring-1 ring-slate-300/60 backdrop-blur-sm dark:ring-slate-400/20">
