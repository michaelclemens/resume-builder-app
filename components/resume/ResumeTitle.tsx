...
export default function ResumeTitle({ resume }: { resume: Resume }) {
  ...
  return (
    <div className="absolute left-1/2 top-0 z-40 mt-4 w-96 rounded-lg bg-slate-300/70 text-slate-800 shadow-md ring-1 ring-slate-700/30 dark:bg-slate-900/70 dark:text-slate-300 dark:ring-slate-400/20">
